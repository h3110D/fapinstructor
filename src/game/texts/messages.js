...
const edgeAndHold_messages = [
  "Edge like this! You will hold it.",
  ...
  "Edge like this. Time to hold it!",
  "Edge like this! Keep yourself right on it!",
  ...
  "Edge just like this. Time to hold it!",
  "Edge just like this! Keep yourself right on it!",
